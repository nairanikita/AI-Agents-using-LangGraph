...
prompt = """You are a smart research assistant. Use the search engine to look up information.You can use tools like search to get real-time or factual answers. \
